...
export class LoadMoreFeedItemsRequest extends TweeterRequest {
  ...
  public static fromJson(json: LoadMoreFeedItemsRequest): LoadMoreFeedItemsRequest {
    interface ILoadMoreFeedItemsRequest {
    ...
    let myObj: ILoadMoreFeedItemsRequest = json as unknown as ILoadMoreFeedItemsRequest;
    ...
    console.log("Return Request: " + JSON.stringify(new LoadMoreFeedItemsRequest(deserializedAuthToken, deserializedUser, myObj._pageSize, deserializedLastItem)));
    return new LoadMoreFeedItemsRequest(deserializedAuthToken, deserializedUser, myObj._pageSize, deserializedLastItem);
  }
}