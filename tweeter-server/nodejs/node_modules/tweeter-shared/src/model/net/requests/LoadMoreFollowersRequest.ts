...
export class LoadMoreFollowersRequest extends TweeterRequest {
  ...
  public static fromJson(json: LoadMoreFollowersRequest) {
    interface ILoadMoreFollowersRequest {
    ...
    let myObj: ILoadMoreFollowersRequest = json as unknown as ILoadMoreFollowersRequest;
    ...
    console.log("Return Request: " + JSON.stringify(new LoadMoreFollowersRequest(deserializedAuthToken, deserializedUser, myObj._pageSize, deserializedLastItem)));
    return new LoadMoreFollowersRequest(deserializedAuthToken, deserializedUser, myObj._pageSize, deserializedLastItem);
  }
}